...
---  If it is `nil`, the opacity defaults to `0.75`.
---* Background blur is applied per-platform: `macos_window_background_blur` (radius from
---  `wezterm.GLOBAL.blur`, defaults to `30`), `win32_system_backdrop` (`"Acrylic"`),
---  and `kde_window_background_blur` (`true`).
